...
using Project.IdentityServer4.STS.Identity.Helpers;
using Project.IdentityServer4.STS.Identity.Helpers.Localization;
using Project.IdentityServer4.STS.Identity.ViewModels.Account;

namespace Project.IdentityServer4.STS.Identity.Controllers
{
    [SecurityHeaders]
    [Authorize]    
