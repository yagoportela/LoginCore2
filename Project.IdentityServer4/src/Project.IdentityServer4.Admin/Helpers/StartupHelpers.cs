...
using Project.IdentityServer4.Admin.ExceptionHandling;
using Project.IdentityServer4.Admin.Middlewares;
using Project.IdentityServer4.Admin.Configuration;
using Project.IdentityServer4.Admin.Configuration.ApplicationParts;
using Project.IdentityServer4.Admin.Configuration.Constants;
using Project.IdentityServer4.Admin.Configuration.Interfaces;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using Project.IdentityServer4.Admin.Helpers.Localization;

namespace Project.IdentityServer4.Admin.Helpers
{
    public static class StartupHelpers
    {
            ...
            where TLogDbContext : DbContext, IAdminLogDbContext
        {
            ...
            services.AddDbContext<TIdentityDbContext>(options =>
                options.UseMySql(configuration.GetConnectionString(ConfigurationConsts.IdentityDbConnectionStringKey),
            ...
            services.AddConfigurationDbContext<TConfigurationDbContext>(options =>
            {
                options.ConfigureDbContext = b =>
                    b.UseMySql(configuration.GetConnectionString(ConfigurationConsts.ConfigurationDbConnectionStringKey),
                        sql => sql.MigrationsAssembly(migrationsAssembly));
            });
            ...
            {
                options.ConfigureDbContext = b =>
                    b.UseMySql(configuration.GetConnectionString(ConfigurationConsts.PersistedGrantDbConnectionStringKey),
                        sql => sql.MigrationsAssembly(migrationsAssembly));
            });
