...
using SendGrid;
using Serilog;
using Project.IdentityServer4.STS.Identity.Configuration;
using Project.IdentityServer4.STS.Identity.Configuration.ApplicationParts;
using Project.IdentityServer4.STS.Identity.Configuration.Constants;
using Project.IdentityServer4.STS.Identity.Configuration.Intefaces;
using Project.IdentityServer4.STS.Identity.Helpers.Localization;
using Project.IdentityServer4.STS.Identity.Services;
using ILogger = Microsoft.Extensions.Logging.ILogger;

namespace Project.IdentityServer4.STS.Identity.Helpers
{
